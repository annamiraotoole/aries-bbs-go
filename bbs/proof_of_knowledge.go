...
type PoKOfSignature struct {
	...
	pokVC1   *ml.ProverCommittedG1
	secrets1 []*ml.Zr

	PokVC2   *ml.ProverCommittedG1
	secrets2 []*ml.Zr
...
type VC2SignatureProvider interface {
	New(*ml.G1, *ml.Zr, *PublicKeyWithGenerators, *ml.Zr, []*SignatureMessage, map[int]*SignatureMessage) (*ml.ProverCommittedG1, []*ml.Zr)
}
...
func (b *BBSLib) newVC1Signature(aPrime *ml.G1, h0 *ml.G1,
	e, r2 *ml.Zr) (*ml.ProverCommittedG1, []*ml.Zr) {
	...
	secrets1[1] = r2
	pokVC1 := b.curve.StartProofG1(rng, bases1, secrets1)
...
func (p *defaultVC2SignatureProvider) New(d *ml.G1, r3 *ml.Zr, pubKey *PublicKeyWithGenerators, sPrime *ml.Zr,
	messages []*SignatureMessage, revealedMessages map[int]*SignatureMessage) (*ml.ProverCommittedG1, []*ml.Zr) {
	...
	pokVC2 := p.bl.curve.StartProofG1(rng, bases2, secrets2)
...
func (pos *PoKOfSignature) GenerateProof(pubKey *PublicKeyWithGenerators, nonce []byte) *PoKOfSignatureProof {
	...
	return &PoKOfSignatureProof{
		...
		aBar:     pos.aBar,
		d:        pos.d,
		proofVC1: pos.curve.FinishProofG1(pos.pokVC1, pos.secrets1, challProvider),
		ProofVC2: pos.curve.FinishProofG1(pos.PokVC2, pos.secrets2, challProvider),
		curve:    pos.curve,
	}
}
