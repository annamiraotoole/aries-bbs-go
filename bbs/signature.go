...
func (b *BBSLib) ParseSignature(sigBytes []byte) (*Signature, error) {
	...
	e := b.parseFr(sigBytes[b.g1CompressedSize : b.g1CompressedSize+b.curve.FrCompressedSize])
...
func (s *Signature) ToBytes() ([]byte, error) {
	bytes := make([]byte, s.curve.CompressedG1ByteSize+s.curve.FrCompressedSize)
